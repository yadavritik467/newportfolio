...
const Experience = () => {
  const projects: {
    ...
    },
    {
      ...
      description: `During my 6-month internship at Exampil Pvt Ltd, I worked as an Angular Developer. I developed an ad-tech website where users can book tempos automatically. The project also included multiple role-based dashboards, providing a comprehensive and user-friendly interface.`,
  ...
  return (
    <div id="experience" className="w-full pt-16">
      ...
      <div className="absolute w-[800px] h-[800px] z-[-2] top-0 bg-primary rounded-lg  left-[-30%]  -rotate-45 "></div>
